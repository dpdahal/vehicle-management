            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>
                                <i class="fa fa-plus"></i> Add Welcome Page Content
                                <a href="{{route('admin-welcome-page.index')}}" class="btn-sm btn-success">
                                    <i class="fa fa-hand-o-right"></i> View Welcome Page</a>
                            </h2>
                        ...
                        <div class="x_content">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <form action="{{route('admin-welcome-page.store')}}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="status"> Status: <a
                                                                    style="color: red;">{{$errors->first('status')}}</a></label>
                                                            <select name="status" id="status" class="form-control">
                                                                <option value="" readonly selected>---Select Status---
                                                                </option>
                                                                <option
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_keywords"
                                                   value="{{'travel,trekking,tours',old('meta_keywords')}}"
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-success"><i
                                                    class="fa fa-plus"></i> Add Welcome Page
                                            </button>
                                        </div>
                                    </form>
                                </div>
