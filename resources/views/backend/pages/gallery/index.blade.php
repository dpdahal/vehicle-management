                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><i class="fa fa-eye"></i> Show Gallery Types
                                ...
                                <a href="{{route('admin-gallery.create')}}" class="btn-sm btn-success">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="{{route('update-gallery-types-status')}}"
                                                              method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="criteria" value="{{$gallery->id}}">
                                                            @if($gallery->status==1)
                                                    ...
                                                    <td>
                                                        @if($gallery->image)
                                                            ...
                                                            <a href="">Total {{$gallery->totalGalleryImage()}} Images: </a>
                                                        @endif
                                                    </td>
